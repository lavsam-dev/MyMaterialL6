...
import kotlinx.android.synthetic.main.activity_anima_bonus_start.*

class AnimaBonusActivity : AppCompatActivity() {

    private var show = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_anima_bonus_start)
    ...
    private fun showComponents() {
        ...
        constraintSet.clone(this, R.layout.activity_anima_bonus_end)
    ...
    private fun hideComponents() {
        ...
        val constraintSet = ConstraintSet()
        constraintSet.clone(this, R.layout.activity_anima_bonus_start)
