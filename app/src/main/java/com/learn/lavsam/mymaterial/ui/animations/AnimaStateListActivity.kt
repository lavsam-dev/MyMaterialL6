...
import kotlinx.android.synthetic.main.activity_anima_state_list.*
import kotlinx.android.synthetic.main.activity_anima_state_list.fab
import kotlinx.android.synthetic.main.activity_anima_state_list.option_one_container
import kotlinx.android.synthetic.main.activity_anima_state_list.option_two_container
import kotlinx.android.synthetic.main.activity_anima_state_list.plus_imageview
import kotlinx.android.synthetic.main.activity_anima_state_list.scroll_view
import kotlinx.android.synthetic.main.activity_anima_state_list.transparent_background

class AnimaStateListActivity : AppCompatActivity() {

    private var isExpanded = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_anima_state_list)
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_two_container.setOnClickListener {
                        Toast.makeText(this@AnimaStateListActivity, "Option 2", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            })
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_one_container.setOnClickListener {
                        Toast.makeText(this@AnimaStateListActivity, "Option 1", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            })
